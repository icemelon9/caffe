...
void ServeNet<Dtype>::Init(const NetParameter& in_param, size_t max_batch) {
  ...
  for (int layer_id = 0; layer_id < param.layer_size(); ++layer_id) {
    ...
    // Set the input batch size to max_batch
    if (param.layer(layer_id).type() == "Input") {
...
template <typename Dtype>
void ServeNet<Dtype>::FilterNet(const NetParameter& param,
...
template <typename Dtype>
bool ServeNet<Dtype>::StateMeetsRule(const NetState& state,
...
template <typename Dtype>
void ServeNet<Dtype>::AppendTop(const NetParameter& param, const int layer_id,
...
template <typename Dtype>
int ServeNet<Dtype>::AppendBottom(const NetParameter& param, const int layer_id,
...
/*
template <typename Dtype>
void ServerNet<Dtype>::AppendParam(const NetParameter& param, const int layer_id,
                             const int param_id) {
...
*/
template <typename Dtype>
Dtype ServeNet<Dtype>::ForwardFromTo(int start, int end) {
  CHECK_GE(start, 0);
...
template <typename Dtype>
Dtype ServeNet<Dtype>::ForwardFrom(int start) {
  return ForwardFromTo(start, layers_.size() - 1);
}

template <typename Dtype>
Dtype ServeNet<Dtype>::ForwardTo(int end) {
  return ForwardFromTo(0, end);
}

template <typename Dtype>
const vector<Blob<Dtype>*>& ServeNet<Dtype>::Forward(Dtype* loss) {
  if (loss != NULL) {
...
template <typename Dtype>
const vector<Blob<Dtype>*>& ServeNet<Dtype>::Forward(
...
/*
template <typename Dtype>
void ServeNet<Dtype>::ForwardDebugInfo(const int layer_id) {
  for (int top_id = 0; top_id < top_vecs_[layer_id].size(); ++top_id) {
...
template <typename Dtype>
void ServeNet<Dtype>::CopyTrainedLayersFrom(const NetParameter& param) {
...
/*
template <typename Dtype>
void ServeNet<Dtype>::CopyTrainedLayersFromHDF5(const string trained_filename) {
...
*/
template <typename Dtype>
void ServeNet<Dtype>::ToProto(NetParameter* param, bool write_diff) const {
  param->Clear();
...
/*
template <typename Dtype>
void ServeNet<Dtype>::ToHDF5(const string& filename, bool write_diff) const {
...
template <typename Dtype>
const shared_ptr<Blob<Dtype> > ServeNet<Dtype>::blob_by_name(
...
template <typename Dtype>
const shared_ptr<Layer<Dtype> > ServeNet<Dtype>::layer_by_name(
